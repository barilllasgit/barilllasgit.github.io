...
var words = [
	new Word(0, "A", "Empieza por A:", " nombre de la espada de Gol D. Roger", "Ace"),
	new Word(1, "B", "Empieza por B:", " nombre de la Tripulación de Bartolomeo", "Barto Club"),
	new Word(2, "C", "Empieza por C:", " que metodo usan los mugiwaras con el Thousand Sunny para salir volando", "Coup de Burst"),
...
function checkAnswer(pos) {
    ...
    var incorrectSound = document.getElementById("incorrect-sound"); // Obtener el elemento de audio para respuestas incorrectas
    ...
    remainingWords--;
    $("#js--score").html(remainingWords); // Corregí el selector aquí
...
$("#js--user-answer").keydown(function(event) {
    if (event.keyCode === 32) { // 32 es el código de la tecla de espacio
        event.stopPropagation(); // Detener la propagación del evento para evitar cambiar la pregunta
    }
});